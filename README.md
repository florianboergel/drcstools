...
```
    ...
    [<matplotlib.lines.Line2D at 0x7efcb9cac280>]
...
```
    ...
    <matplotlib.legend.Legend at 0x7efcb9b08eb0>
...
```
    ...
    <matplotlib.legend.Legend at 0x7efcb9ad52b0>
...
```
    ...
    <matplotlib.legend.Legend at 0x7efcb9a04520>
...
```python
obj.derivative("slp", N = 10, dim = "lon") 
obj.derivative("slp", N = 10, dim = "lon", order = 2) # 2nd derivative 
```
...
.xr-icon-file-text2 {
  ...
  fill: currentColor;
...
</style><div class='xr-wrap'><div class='xr-header'><div class='xr-obj-type'>xarray.Dataset</div></div><ul class='xr-sections'><li class='xr-section-item'><input id='section-cad7b856-deca-4828-933d-c4859b0a70d6' class='xr-section-summary-in' type='checkbox' disabled ><label for='section-cad7b856-deca-4828-933d-c4859b0a70d6' class='xr-section-summary'  title='Expand/collapse section'>Dimensions:</label><div class='xr-section-inline-details'><ul class='xr-dim-list'><li><span class='xr-has-index'>lat</span>: 95</li><li><span class='xr-has-index'>lon</span>: 85</li><li><span class='xr-has-index'>time</span>: 5</li></ul></div><div class='xr-section-details'></div></li><li class='xr-section-item'><input id='section-36c77b5e-36d6-4051-898f-836afc10c0b7' class='xr-section-summary-in' type='checkbox'  checked><label for='section-36c77b5e-36d6-4051-898f-836afc10c0b7' class='xr-section-summary' >Coordinates: <span>(3)</span></label><div class='xr-section-inline-details'></div><div class='xr-section-details'><ul class='xr-var-list'><li class='xr-var-item'><div class='xr-var-name'><span class='xr-has-index'>time</span></div><div class='xr-var-dims'>(time)</div><div class='xr-var-dtype'>object</div><div class='xr-var-preview xr-preview'>7500-01-01 00:00:00 ... 7500-01-01 12:00:00</div><input id='attrs-570c3ced-23be-49eb-b4e4-81a577824576' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-570c3ced-23be-49eb-b4e4-81a577824576' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-b414b08f-c70f-4227-b7cd-8bd2df7926fe' class='xr-var-data-in' type='checkbox'><label for='data-b414b08f-c70f-4227-b7cd-8bd2df7926fe' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>standard_name :</span></dt><dd>time</dd><dt><span>axis :</span></dt><dd>T</dd></dl></div><pre class='xr-var-data'>array([cftime.DatetimeProlepticGregorian(7500-01-01 00:00:00),
       ...
       cftime.DatetimeProlepticGregorian(7500-01-01 12:00:00)], dtype=object)</pre></li><li class='xr-var-item'><div class='xr-var-name'><span class='xr-has-index'>lon</span></div><div class='xr-var-dims'>(lon)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>-21.61 -21.17 ... 14.91 15.35</div><input id='attrs-ee4cad96-4502-41f1-8235-62f73e4a2aae' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-ee4cad96-4502-41f1-8235-62f73e4a2aae' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-b1168244-6492-4a37-a0f5-2e5c7a07f885' class='xr-var-data-in' type='checkbox'><label for='data-b1168244-6492-4a37-a0f5-2e5c7a07f885' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>standard_name :</span></dt><dd>longitude</dd><dt><span>long_name :</span></dt><dd>longitude in rotated pole grid</dd><dt><span>units :</span></dt><dd>degrees</dd><dt><span>axis :</span></dt><dd>X</dd></dl></div><pre class='xr-var-data'>array([-21.61, -21.17, -20.73, -20.29, -19.85, -19.41, -18.97, -18.53, -18.09,
       ...
       -13.69, -13.25, -12.81, -12.37, -11.93, -11.49, -11.05, -10.61, -10.17,
        ...
        14.03,  14.47,  14.91,  15.35])</pre></li><li class='xr-var-item'><div class='xr-var-name'><span class='xr-has-index'>lat</span></div><div class='xr-var-dims'>(lat)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>-20.57 -20.13 ... 20.35 20.79</div><input id='attrs-d77a521e-2d95-4851-a935-b127b498ebab' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-d77a521e-2d95-4851-a935-b127b498ebab' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-2cc6996c-4b06-4597-906b-37d410e8a91b' class='xr-var-data-in' type='checkbox'><label for='data-2cc6996c-4b06-4597-906b-37d410e8a91b' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>standard_name :</span></dt><dd>latitude</dd><dt><span>long_name :</span></dt><dd>latitude in rotated pole grid</dd><dt><span>units :</span></dt><dd>degrees</dd><dt><span>axis :</span></dt><dd>Y</dd></dl></div><pre class='xr-var-data'>array([-20.57, -20.13, -19.69, -19.25, -18.81, -18.37, -17.93, -17.49, -17.05,
       ...
       -12.65, -12.21, -11.77, -11.33, -10.89, -10.45, -10.01,  -9.57,  -9.13,
        ...
        19.03,  19.47,  19.91,  20.35,  20.79])</pre></li></ul></div></li><li class='xr-section-item'><input id='section-9e85b132-229e-4f00-875b-b95f5ca82c7d' class='xr-section-summary-in' type='checkbox'  checked><label for='section-9e85b132-229e-4f00-875b-b95f5ca82c7d' class='xr-section-summary' >Data variables: <span>(3)</span></label><div class='xr-section-inline-details'></div><div class='xr-section-details'><ul class='xr-var-list'><li class='xr-var-item'><div class='xr-var-name'><span>slp</span></div><div class='xr-var-dims'>(time, lat, lon)</div><div class='xr-var-dtype'>float32</div><div class='xr-var-preview xr-preview'>102554.56 102556.56 ... 102995.25</div><input id='attrs-f6b26716-33ad-4f79-9821-2670a38b0011' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-f6b26716-33ad-4f79-9821-2670a38b0011' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-ffb3726e-2834-4564-8e4c-214a4f3c5f63' class='xr-var-data-in' type='checkbox'><label for='data-ffb3726e-2834-4564-8e4c-214a4f3c5f63' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>table :</span></dt><dd>1</dd></dl></div><pre class='xr-var-data'>array([[[102554.56, 102556.56, ..., 102230.56, 102230.56],
       ...
       [[102313.25, 102297.25, ..., 102163.25, 102169.25],
        ...
        [101875.25, 101877.25, ..., 102955.25, 102995.25]]], dtype=float32)</pre></li><li class='xr-var-item'><div class='xr-var-name'><span>ddlonslp</span></div><div class='xr-var-dims'>(time, lat, lon)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>25.99 23.4 19.21 ... -58.7 -70.46</div><input id='attrs-374aebb3-33dc-4079-9908-9b237438771f' class='xr-var-attrs-in' type='checkbox' disabled><label for='attrs-374aebb3-33dc-4079-9908-9b237438771f' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-0262c76f-6d76-4645-823e-50c052b93d3d' class='xr-var-data-in' type='checkbox'><label for='data-0262c76f-6d76-4645-823e-50c052b93d3d' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'></dl></div><pre class='xr-var-data'>array([[[ 25.9859848 ,  23.3961792 ,  19.20761681, ...,  21.44711113,
       ...
       [[  6.5656085 ,   5.11815643,   3.113204  , ...,   6.02027512,
        ...
        [-75.98180389, -75.02171326, -68.9028244 , ..., -42.44375229,
         -58.69573212, -70.460289  ]]])</pre></li><li class='xr-var-item'><div class='xr-var-name'><span>d2dlonslp</span></div><div class='xr-var-dims'>(time, lat, lon)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>-0.7862 -1.185 ... -5.806 -4.698</div><input id='attrs-2ad357d6-875e-48fe-ac8d-435b36c45574' class='xr-var-attrs-in' type='checkbox' disabled><label for='attrs-2ad357d6-875e-48fe-ac8d-435b36c45574' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-38632d58-1746-43eb-9ace-a5012ae13902' class='xr-var-data-in' type='checkbox'><label for='data-38632d58-1746-43eb-9ace-a5012ae13902' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'></dl></div><pre class='xr-var-data'>array([[[-0.78618085, -1.18455279, -1.47825718, ...,  0.35999504,
...
```
    ...
    <xarray.plot.facetgrid.FacetGrid at 0x7efcb91aa100>
...
```
    ...
    <xarray.plot.facetgrid.FacetGrid at 0x7efcb8f89370>
...
```
    ...
    <xarray.plot.facetgrid.FacetGrid at 0x7efcb85f0e50>
